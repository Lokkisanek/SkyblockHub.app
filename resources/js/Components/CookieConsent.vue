    ...
    >
        ...
        >
            <div class="mb-1 flex items-center gap-2">
                ...
                <h3 class="text-sm font-bold text-white">This site uses cookies</h3>
            </div>
            <p class="text-xs leading-relaxed text-white/55">
                We use <strong class="text-white/70">essential cookies</strong> to keep you logged in and make the site work. You can also allow all cookies for a better experience. Read more in our
                <Link :href="route('privacy')" class="text-white/70 underline underline-offset-2 hover:text-white">Privacy Policy</Link>.
            </p>
