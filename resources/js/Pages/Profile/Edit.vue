                        ...
                        <header>
                            ...
                            <p class="mt-1 text-sm text-neutral">
                                <template v-if="isMcLinked">
                                    Tvůj Minecraft účet je propojen.
                                </template>
                                <template v-else>
                                    Propoj svůj Minecraft účet pro přístup k dalším funkcím.
                                </template>
                            </p>
                        </header>
                            ...
                            <template v-if="isMcLinked">
                                <div class="flex items-center gap-3 rounded-lg border border-[#0bca51]/25 bg-[#0bca51]/8 p-3">
                                    ...
                                    <div class="flex-1">
                                        ...
                                        <p class="text-xs text-[#55FF55]">Propojeno</p>
                                    </div>
                                    <button
                                ...
                                <div class="flex flex-col gap-4">
                                    <div v-if="!discordUsername">
                                        <p class="text-sm text-neutral mb-3">
                                            Pro ověření vlastnictví Minecraft účtu je potřeba propojit Discord.
                                            Na Hypixelu musíš mít v profilu nastavený svůj Discord nick.
                                        </p>
                                        <a
                                    ...
                                    <div v-else>
                                        <p class="text-sm text-neutral mb-2">
                                            Discord propojen jako <strong class="text-white">{{ discordUsername }}</strong>.
                                            Zadej své Minecraft jméno — ověříme ho přes tvůj Hypixel profil.
                                        </p>
                                        ...
                                        >
                                            Jak nastavit Discord na Hypixelu?
                                        </button>
                                        ...
                                        <div class="flex gap-2">
                                            <input
                                                ...
                                                type="text"
                                                placeholder="Zadej své MC jméno"
                                            ...
                                            >
                                                <span v-if="mcForm.processing">Ověřuji...</span>
                                                <span v-else>Propojit</span>
                                            </button>
                                        </div>
